...
@interface ThirdPlanController () <UITableViewDelegate,UITableViewDataSource>
{
...
@implementation ThirdPlanController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[select_dic objectForKey:@"PersonCD"] hasPrefix:@"s"]) {
        ...
        //push进入下一级
        ForthPlanController *second = [[ForthPlanController alloc] init];
