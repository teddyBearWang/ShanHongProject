...
@interface ContactSecondController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation ContactSecondController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([sid hasPrefix:@"s"]) {
        ...
        //表示乡镇
        ContactThirdController *third = [[ContactThirdController alloc] init];
        third.sid = sid;
        third.title_name = title;
